/* eslint-disable react-hooks/refs, react-hooks/purity, react-hooks/immutability, react-hooks/preserve-manual-memoization, no-useless-assignment -- vendored ElevenLabs code, kept close to upstream */
/**
 * Orb — WebGL voice-agent orb, ported from ElevenLabs UI (MIT).
 * https://ui.elevenlabs.io/docs/components/orb
 *
 * Changes from upstream: TSX → JSX, drei's useTexture → fiber's useLoader,
 * perlin texture served locally from /public instead of the ElevenLabs CDN.
 */
...
export function Orb({
  ...
  return (
    <div className={className ?? "orb-canvas"}>
      <Canvas
